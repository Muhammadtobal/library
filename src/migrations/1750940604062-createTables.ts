...
export class CreateTables1750940604062 implements MigrationInterface {
    name = 'CreateTables1750940604062'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`review\` ADD \`description\` varchar(255) NOT NULL`);
